...
// Adapted for Pixelflow
// Commit e39c1e0994ac2adabd8a617635db3e35f04cce88
//
//===- Open3D/cpp/core/SmallVector.cpp -===//
//
// Part of the Open3D library, under the MIT License.
// See https://github.com/isl-org/Open3D/blob/main/LICENSE for license information.
...
template <typename T>
inline void swap(pixelflow::core::SmallVectorImpl<T> &LHS,
                 pixelflow::core::SmallVectorImpl<T> &RHS) {
    LHS.swap(RHS);
}

/// Implement std::swap in terms of SmallVector swap.
template <typename T, unsigned N>
inline void swap(pixelflow::core::SmallVector<T, N> &LHS,
                 pixelflow::core::SmallVector<T, N> &RHS) {
    LHS.swap(RHS);
}
